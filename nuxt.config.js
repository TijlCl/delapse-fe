export default {
  ...
  fontawesome: {
    icons: {
      solid: ['faHome', 'faKey', 'faUser', 'faEnvelopeOpen', 'faLock', 'faArrowRight', 'faPlus', 'faArrowLeft', 'faCalendarAlt', 'faBookOpen', 'faChevronDown', 'faTrash', 'faSearch', 'faUserPlus', 'faUpload'],
    }
  },
